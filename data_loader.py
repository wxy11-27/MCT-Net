...
def build_datasets(root, dataset, size, n_select_bands, scale_ratio):
    ...
    if dataset == 'Pavia':
        ...
        img = scio.loadmat(root + '/' + 'Houston_HSI.mat')['Houston_HSI']*1.0
    elif dataset == 'MUUFL_HSI':
        img = scio.loadmat(root + '/' + 'MUUFL_HSI.mat')['MUUFL_HSI']*1.0
    elif dataset == 'salinas_corrected':
        img = scio.loadmat(root + '/' + 'salinas_corrected.mat')['salinas_corrected']*1.0
